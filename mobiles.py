...
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a href="redmi.py?id=%s" onclick="myfunction()">Redmi</a></li>
...
q = """Select * from user_sell where category='mobile' """
cur.execute(q)
rec = cur.fetchall()
for i in rec:
    print("""
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-primary" onclick="myfunction()">Buy Now</a>
              </div>
            </div>
            </div>
    """ % (i[6], i[3], i[4], i[5]))
