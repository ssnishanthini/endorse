...
<head>
    ...
    <title>Firsthand Products</title>
    ...
    print("""
            ...
            <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="buy_now.py?id=%s&bid=%s&sellid=%s" class="btn btn-primary">Buy Now</a>
              </div>
            </div>
            </div>
    """ % (i[6], i[3], i[4], i[5], uid, i[0], i[7]))
