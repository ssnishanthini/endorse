              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  ...
                  <form method="post" enctype="multipart/form-data">
                      ...
                      <a href="forgetpassword.py" style="margin-left: -180px; text-decoration: none;">Forget Password</a>
                  <br>
                  <br>
                      ...
                      <center><hr width="90%"></center>
                      <p>New Users kindly <a href="./userreg.py" style="font-size: 15px; color: black;">Register</a> yourself.</p>
                  </center>
                  </form>
                  </div>
                  </div>
...
if Login != None:
    q="""Select id from userreg where email="%s" and password="%s" """%(Email,Password)
    cur.execute(q)
    rec=cur.fetchone()
    if rec != None:
        print("""
