                ...
                <div class="col-md-1"></div>
                          <div class="col-md-5">
                            ...
                            <br>
                                ...
                                <center><hr width="90%"></center>
                                <p>If already registered <a href="./business_login.py" style="font-size: 15px; color: black;">Login</a> yourself.</p>
                            </center>
                            </form>
                            </div>
                            </div>
                            <div class="col-md-5" id="new" style="background-color:pink">
                              <div class="box">
                              <center>
...
if Register != None:
    ...
    q = """INSERT INTO business_reg(name,email,password,gender,mobile,address,pincode,photo,status)values('%s','%s','%s','%s','%s','%s','%s','%s','false')""" % (
